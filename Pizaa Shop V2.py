import random  # Importing the random module to generate a random order number
import datetime  # Importing the datetime module to get the current date and time

# Generating a random order number between 10000 and 99999
order_number = random.randint(10000, 99999)
# Getting the current date and time
current_datetime = datetime.datetime.now()

# Function to print the order number
...
# Function to print pizza information
def pizza_info(name, price, ingredients):
    print(f"Name: {name}")
    print(f"Price: ${float(price)} for each one")
    print("Ingredients:")
    # Looping through the ingredients list and printing each one
...
while True:
    ...
    if customer_name:
        ...
        # ---------------------------------------------------------------------------------
        # Handling the case where the user selects Margherita Pizza
        if choice == "1":
            while True:
                print("-" * 25)
                ...
                if choice_Margherita == '1':
                    print("-" * 15)
                    pizza_info(name='Margherita Pizza', price=45,
                               ingredients=["Pizza dough", "Tomato sauce", "Mozzarella cheese", "Fresh basil leaves", "Olive oil", "Salt"])
                    ...
                    print("-" * 5)
                    print(
                        f"You will receive {num_of_margherita} Margherita pizzas: {small_size} Small, {medium_size} Medium, and {large_size} Large to '{address}' within 25 minutes.")
            ...
            break
        # -------------------------------------------------------------------------------------------
        # Handling the case where the user selects Pepperoni Pizza
        elif choice == "2":
            while True:
                print("-" * 25)
                ...
                if choice_Pepperoni == "1":
                    print("-" * 15)
                    pizza_info(name='Pepperoni Pizza', price=50,
                               ingredients=["Pizza dough", "Tomato sauce", "Mozzarella cheese", "Pepperoni slices", "Olive oil", "Grated Parmesan cheese", "Dried oregano"])
                    ...
                    print("-" * 5)
                    print(
                        f"You will receive {num_of_Pepperoni} Pepperoni pizzas: {small_size} Small, {medium_size} Medium, and {large_size} Large to '{address}' within 25 minutes.")
                    Order_number(order_number)
                    Current_datatime(current_datetime)
                    print(f"Thank you '{customer_name}' for being part of Pizza Shop!")
                    break
        ...
        # Handling the case where the user selects Hawaiian Pizza
        elif choice == "3":
            while True:
                print("-" * 25)
                ...
                if choice_Hawaiian == "1":
                    print("-" * 15)
                    pizza_info(name='Hawaiian Pizza', price=60,
                    ingredients=["Pizza dough", "Tomato sauce", "Mozzarella cheese", "Chicken pieces", "Olive oil", "Pineapple chunks", "Dried oregano"])
                    ...
                    print("-" * 5)
                    print(
                        f"You will receive {num_of_Hawaiian} Hawaiian pizzas: {small_size} Small, {medium_size} Medium, and {large_size} Large to '{address}' within 25 minutes.")
                    Order_number(order_number)
                    Current_datatime(current_datetime)
                    print(f"Thank you '{customer_name}' for being part of Pizza Shop!")
                    break
        ...
        # Handling the case where the user selects Special Pizza
        elif choice == "4":
            print("-" * 25)
            print("#Special Pizza!")
            select_ingredients = []
            ...
            while True:
                ...
                if choice_Special == "1":
                    ...
                    print("-" * 5)
                    print(
                        f"You will receive {num_of_Special} Special pizzas: {small_size} Small, {medium_size} Medium, and {large_size} Large to '{address}' within 25 minutes.")
                    Order_number(order_number)
                    Current_datatime(current_datetime)
                    print(f"Thank you '{customer_name}' for being part of Pizza Shop!")
                    break
